...
export const WorkData: WorkDataType[] = [
  {
    ...
    description: 'TabletopTown was an Android and iOS application that <a href="http://www.peterfreeby.com" target="_blank" rel="noopener noreferrer">Peter Freeby</a> and I began working on in 2020, eventually bringing on other folks to help build it, and we launched the app in 2023. At its core, it was an instant messaging app that allowed users to play tabletop roleplaying games asynchronously. The app included a set of creator tools that empowered users to modify game systems and other content in their library, mod games on the fly while playing, and even publish original content to the marketplace. It used Flutter for the UI, AWS for the database, Hasura to generate a GraphQL API to interface with the database, and Firebase for user authentication. The app was shut down in 2025.',
    images: [
      {
        subTitle: 'Game Chat',
        thumbnail: '/tabletoptown/t3-chat-screen-thumbnail.jpg',
        fullSize: '/tabletoptown/t3-chat-screen-full-size.jpg',
        caption: 'The core of the experience revolved around the chat screen, where users could interact with each other, speak in character or out of character, access their character sheet and notes, roll dice, and more.',
      },
      {
        ...
        caption: 'The dice roller was a key feature of the app, allowing users to roll dice and see the results in the chat.',
      },
      {
        ...
        caption: 'The creator tools were what gave users the ability to modify the game and any content they owned.',
      },
      {
        subTitle: 'Marketplace',
        thumbnail: '/tabletoptown/t3-marketplace-thumbnail.jpg',
        fullSize: '/tabletoptown/t3-marketplace-full-size.jpg',
        caption: 'The marketplace empowered creators to share their work with the world, and other users could buy their content to use in their own games.',
      },
    ],
  },
  {
